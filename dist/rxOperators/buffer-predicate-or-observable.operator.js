...
exports.BufferPredicateOrObservable = exports.BufferPredicateOrObservableOperator = void 0;
 ...
 */
var BufferPredicateOrObservableOperator = /** @class */ (function () {
    /**
 ...
 * @param {Observable<any>} closingNotifier - Notify before closing
 */
var BufferPredicateOrObservable = /** @class */ (function (_super) {
    ...
    function BufferPredicateOrObservable(destination, predicate, closingNotifier) {
         ...
         */
        _this.buffer = [];
        _this.add((0, subscribeToResult_1.subscribeToResult)(_this, closingNotifier));
        return _this;
    }
    /**
     * @method notifyNext
